                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _InfoChip(
                              ...
                              label: '${topic.quizCount} ${topic.quizCount == 1 ? 'quiz' : 'quizzes'}',
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: scoreColor.withValues(alpha: isDark ? 0.12 : 0.07),
                            borderRadius: BorderRadius.circular(12),
                          ),
                          child: score == null
                              ? const Row(
                                  children: [
                                    Icon(Icons.insights_outlined, size: 18, color: AppColors.textMuted),
                                    SizedBox(width: 8),
                                    Expanded(
                                      child: Text(
