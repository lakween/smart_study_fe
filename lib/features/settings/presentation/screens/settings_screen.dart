    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          SwitchListTile(value: _quizReminders, onChanged: (v) => setState(() => _quizReminders = v), secondary: const Icon(Icons.quiz_outlined), title: const Text('Quiz Reminders'), activeColor: AppColors.primary),
          SwitchListTile(value: _examReminders, onChanged: (v) => setState(() => _examReminders = v), secondary: const Icon(Icons.assignment_outlined), title: const Text('Exam Reminders'), activeColor: AppColors.primary),
          SwitchListTile(value: _friendRequests, onChanged: (v) => setState(() => _friendRequests = v), secondary: const Icon(Icons.person_add_outlined), title: const Text('Friend Requests'), activeColor: AppColors.primary),
          SwitchListTile(value: _spacedRepetition, onChanged: (v) => setState(() => _spacedRepetition = v), secondary: const Icon(Icons.refresh), title: const Text('Spaced Repetition'), activeColor: AppColors.primary),
          const Divider(),
          ...
          const Divider(),
          _SectionTitle('About'),
          ListTile(leading: const Icon(Icons.info_outline), title: const Text('App Version'), trailing: Text(AppConstants.appVersion, style: const TextStyle(color: AppColors.textMuted))),
